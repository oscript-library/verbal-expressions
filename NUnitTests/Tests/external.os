...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьМодификаторРегулярногоВыражения");
	ВсеТесты.Добавить("ТестДолжен_ПроверитьШорткаты");
...
Процедура ТестДолжен_ПроверитьМодификаторРегулярногоВыражения() Экспорт

	Результат = Новый ВербальноеВыражение()
        .Найти("а")
	    .СЛюбымРегистром(Истина)
	    .ВРегулярноеВыражение();
	
	юТест.ПроверитьИстину(Результат.Совпадает("А"));

	Результат = Новый ВербальноеВыражение()
	    .Найти("а")
	    .СЛюбымРегистром(Ложь)
	    .ВРегулярноеВыражение();
	
	юТест.ПроверитьЛожь(Результат.Совпадает("А"));
	
КонецПроцедуры

Процедура ТестДолжен_ПроверитьШорткаты() Экспорт
	...
	юТест.ПроверитьИстину(Результат.Совпадает("12 "));
	юТест.ПроверитьЛожь(Результат.Совпадает("ф"));
